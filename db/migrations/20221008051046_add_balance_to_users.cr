class AddBalanceToUsers::V20221008051046 < Avram::Migrator::Migration::V1
  def migrate
    ...
    alter table_for(User) do
      add wallet_pubkey : String, default: ""
      add wallet_privkey : String, default: ""
    end
  ...
  def rollback
    ...
    alter table_for(User) do
      remove :wallet_pubkey
      remove :wallet_privkey
    end
  end
end
